(() => {
  ...
  function homeScreen() {
    ...
    return `<section class="screen" data-screen-view="home">
      ...
      <article class="home-stable"><div class="home-stable-head"><div class="home-coin">${svg('coins')}</div><div><span class="eyebrow">GLOBAL SETTLEMENT</span><h2>스테이블코인 해외송금</h2><p>원화로 보내고, 신고된 전문 사업자를 통해 USDC로 빠르게 정산하는 흐름을 확인해보세요.</p></div></div><div class="home-stable-flow"><span>원화</span><b>›</b><span>신고 사업자</span><b>›</b><span>USDC</span><b>›</b><span>현지 수령</span></div><div class="home-stable-numbers"><div><small>${fmt(state.stableAmount)}만원 송금 예시</small><strong>${stable.usdc.toFixed(2)} USDC</strong></div><div><small>예상 이용 비용</small><strong>${Math.round(stable.fee/10000).toLocaleString('ko-KR')}만원</strong></div></div><button class="stable-entry" data-action="stablecoin">해외송금 구조 알아보기 ${svg('arrow')}</button></article>
